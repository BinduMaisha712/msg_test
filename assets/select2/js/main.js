...
// Close category menu when clicking anywhere on the body
$(document).on('click', function (event) {
    // Check if the clicked element is not inside .cat-toggle or .category-menu
    if (!$(event.target).closest('.cat-toggle, .category-menu').length) {
...
$('.category-active').slick({
	...
	slidesToShow: 6,
	slidesToScroll: 1,
	prevArrow: '<a class="slide-arrow prev-arrow"><i class="fa fa-arrow-left"></i></a>',
    nextArrow: '<a class="slide-arrow next-arrow"><i class="fa fa-arrow-right"></i></a>',
	responsive: [
		{
			breakpoint: 1200,
			settings: {
