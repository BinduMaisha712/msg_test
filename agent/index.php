        ...
        <div class="row gutter-20">
                    ...
                    <div class="miniStats--panel">
                        ...
                        <div class="miniStats--body">
                            ...
                            if (!empty($_POST['fromdate'])) {
                                ...
                                $todate = $_POST['todate'];
                                $sel_query1 = mysqli_query($conn, "SELECT count(id) as completedOrder FROM `order_tbl`  WHERE userid = '$agentuid' AND `date` BETWEEN '$fromdate' AND '$todate'");
                        ...
                        $(document).ready(function() {
                            $("#orderAll,#orderAll1").click(function(url) {
                                ...
                                var win = window.open("view-order.php?fromdate=" + fromdate +
                                    "&todate=" + todate + "&status=all", '_blank');
                                win.focus();
                            });
                    ...
                    <div class="miniStats--panel">
                        ...
                        <div class="miniStats--body">
                            ...
                            <a href="javascript:;" id="completeorder1">
                                <p class="miniStats--caption text-success" style="margin-top: -24px;">By Date</p>
                                <h3 class="miniStats--title h4">Completed Orders</h3>
                            </a>
                            <?php
                            if (!empty($_POST['fromdate'])) {
                                $fromdate = $_POST['fromdate'];
            ...
            <div class="col-md-3">
                ...
                //   }
                    ...
                    $sel_query1 = mysqli_query($conn, "SELECT count(id) as completedOrder FROM `order_tbl`  WHERE order_status = 'Pending' AND userid = '$agentuid' AND `date` BETWEEN '$fromdate' AND '$todate'");
                    $sel_data1 = mysqli_fetch_array($sel_query1);
                ...
                //     $datas = count($order_id);
                //   }
                    // $msq = "SELECT count(id) as completedOrder FROM `order_tbl`  WHERE order_status = 'Pending' AND userid = '$agentuid' AND `date` BETWEEN '$fromdate' AND '$todate'";
                    // echo $msq;exit;
                ...
                ?>
                        ...
                        $(document).ready(function() {
                            $("#pendingorder,#pendingorder1").click(function(url) {
                                ...
                                var todate = $("#todate").val();
                                var win = window.open("view-order.php?fromdate=" + fromdate +
                                    "&todate=" + todate + "&status=Pending", '_blank');
                                win.focus();
                            });
                    ...
                    <div class="miniStats--panel">
                        ...
                        <div class="miniStats--body">
                            ...
                            if (!empty($_POST['fromdate'])) {
                                $fromdate = $_POST['fromdate'];
                                $todate = $_POST['todate'];
                                $msq = "SELECT COUNT(DISTINCT `order_id`) AS `completedOrder` FROM `order_status` WHERE `user_id` = '$agentuid' AND `tracking_status` = 'Cancelled' AND `date` BETWEEN '$fromdate' AND '$todate';";
                                // $sel_query1 = mysqli_query($conn, "SELECT count('order_id') AS completedOrder FROM `order_status` WHERE `user_id` = '$agentuid' AND `tracking_status` = 'Cancelled' AND `date` BETWEEN '$fromdate' AND '$todate';");
                                $sel_query1 = mysqli_query($conn, $msq);
                                $sel_data1 = mysqli_fetch_array($sel_query1);
                        ...
                        $(document).ready(function() {
                            $("#canceledOrder,#canceledOrder1").click(function(url) {
                                ...
                                var todate = $("#todate").val();
                                var win = window.open("view-order.php?fromdate=" + fromdate +
                                    "&todate=" + todate + "&status=CancelledProduct", '_blank');
                                win.focus();
                            });
                    ...
                    <div class="miniStats--panel">
                        ...
                        <div class="miniStats--body">
                            ...
                            if (!empty($_POST['fromdate'])) {
                                $fromdate = $_POST['fromdate'];
                                $todate = $_POST['todate'];
                                // $sel_query1 = mysqli_query($conn, "SELECT count(*) AS completedOrder FROM `order_status` WHERE `user_id` = '$agentuid' AND `tracking_status` = 'Delivered' AND `date` BETWEEN '$fromdate' AND '$todate';");
                                $msq = "SELECT COUNT(DISTINCT `order_id`) AS `completedOrder` FROM `order_status` WHERE `user_id` = '$agentuid' AND `tracking_status` = 'Delivered' AND `date` BETWEEN '$fromdate' AND '$todate';";
                                // echo $msq; exit;
                                $sel_query1 = mysqli_query($conn, $msq);
                                $sel_data1 = mysqli_fetch_array($sel_query1);
                        ...
                        $(document).ready(function() {
                            $("#deliveredOrder,#deliveredOrder1").click(function(url) {
                                ...
                                var todate = $("#todate").val();
                                var win = window.open("view-order.php?fromdate=" + fromdate +
                                    "&todate=" + todate + "&status=Delivered", '_blank');
                                win.focus();
                            });
                    ...
                    <div class="miniStats--panel">
                        ...
                        <div class="miniStats--body">
                            ...
                            if (!empty($_POST['fromdate'])) {
                                $fromdate = $_POST['fromdate'];
                                $todate = $_POST['todate'];
                                // $sel_query1 = mysqli_query($conn, "SELECT count(*) AS completedOrder FROM `order_status` WHERE `user_id` = '$agentuid' AND `tracking_status` = 'your item out for delivery' AND `date` BETWEEN '$fromdate' AND '$todate';");
                                // $msq = "SELECT COUNT(DISTINCT `order_id`) AS `completedOrder` FROM `order_status` WHERE `user_id` = '$agentuid' AND `tracking_status` = 'your item out for delivery' AND `date` BETWEEN '$fromdate' AND '$todate';";
                                $sql = "SELECT COUNT(*) AS completedOrder FROM `order_status` AS os1 WHERE `date` BETWEEN '$fromdate' AND '$todate' AND `user_id` = '$agentuid' AND `tracking_status` = 'your item out for delivery' AND NOT EXISTS (SELECT 1 FROM `order_status` AS os2 WHERE os2.`order_id` = os1.`order_id` AND os2.`tracking_status` IN ('Delivered', 'Cancelled'));";
                                $sel_query1 = mysqli_query($conn, $sql);
                                $sel_data1 = mysqli_fetch_array($sel_query1);
                        ...
                        $(document).ready(function() {
                            $("#outForDelivery,#outForDelivery1").click(function(url) {
                                ...
                                var todate = $("#todate").val();
                                var win = window.open("view-order.php?fromdate=" + fromdate +
                                    "&todate=" + todate + "&status=OutForDelivery", '_blank');
                                win.focus();
                            });
                    ...
                    <div class="miniStats--panel">
                        ...
                        <div class="miniStats--body">
                            ...
                            if (!empty($_POST['fromdate'])) {
                                $fromdate = $_POST['fromdate'];
                                $todate = $_POST['todate'];
                                // $sel_query1 = mysqli_query($conn, "SELECT count(*) AS completedOrder FROM `order_status` WHERE `user_id` = '$agentuid' AND `tracking_status` = 'Your Order has been placed' AND `date` BETWEEN '$fromdate' AND '$todate';");
                                $msq = "SELECT COUNT(DISTINCT `order_id`) AS `completedOrder` FROM `order_status` WHERE `user_id` = '$agentuid' AND `tracking_status` = 'Your Order has been placed' AND `date` BETWEEN '$fromdate' AND '$todate';";
                                $sel_query1 = mysqli_query($conn, $msq);
                                $sel_data1 = mysqli_fetch_array($sel_query1);
                        ...
                        $(document).ready(function() {
                            $("#recievedOrders,#recievedOrders1").click(function(url) {
                                ...
                                var todate = $("#todate").val();
                                var win = window.open("view-order.php?fromdate=" + fromdate +
                                    "&todate=" + todate + "&status=Received", '_blank');
                                win.focus();
                            });
