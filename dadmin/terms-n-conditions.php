            ...
            <section class="main--content">                
                <div class="panel">
                    ...
                    <div class="records--body">
                        <div class="title">
                            <h6 class="h6">Terms and Conditions</h6>
                        </div>
...
<?php
    ...
    if(isset($_POST['submit']))
    {
     ...
     $ins=mysqli_query($conn,"INSERT INTO `terms&conditions_title`(`title`) VALUES ('$title')");
    $last=mysqli_insert_id($conn);
        $description=$_POST['description'];
    foreach($description as $key => $value)
        {
            $value = mysqli_real_escape_string($conn, $value);
            $query=mysqli_query($conn,"INSERT INTO `terms&condition`(`title_id`, `description`) VALUES ('$last','$value')");
             }
             if($query){
