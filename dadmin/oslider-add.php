                         ...
                         <div class="row">
                                                ...
                                                while ($row = mysqli_fetch_assoc($sql)) {
                                                    ...
                                                    if (mysqli_num_rows($sel_query) > 0) {
                                                        while ($data = mysqli_fetch_array($sel_query)) { ?>
                                                         <option value="<?php echo "subcat_" . $data['id']; ?>" <?php if (isset($_POST['subcategory'])) {
                                                                                                                    if ($_POST['subcategory'] == 'subcat_' . $data['id']) {
                                                                                                                        echo "selected";
                                                                                                                    }
                                                                                                                } ?>>
                                                     ...
                                                     <option value="cat_<?= $row['id']; ?>" <?php if (isset($_POST['subcategory'])) {
                                                                                                if ($_POST['subcategory'] == 'cat_' . $row['id']) {
                                                                                                    echo "selected";
                                                                                                }
                                                                                            } ?>>
                                                         <?= $row['cat_name']; ?></option>
                                 ...
                                 <div class="form-group">
                                     <label>
                                         ...
                                         <select name="oftype" required="" class="form-control">
                                             ...
                                             <option value="flat" <?php if (isset($_POST['oftype'])) {
                                                                        if ($_POST['oftype'] == 'flat') {
                                                                            echo "selected";
                                                                        }
                                                                    } ?>>
                                                 Flat</option>
                                             <option value="per" <?php if (isset($_POST['oftype'])) {
                                                                        if ($_POST['oftype'] == 'per') {
                                                                            echo "selected";
                                                                        }
                                                                    } ?>>
                             ...
                             <div class="col-md-8">
                                 <div class="form-group">
                                     <label>
                                         ...
                                         <input type="text" name="offvalue" class="form-control" required placeholder="Enter value for off" value="<?php if (isset($_POST['offvalue'])) {
                                                                                                                                                        echo $_POST['offvalue'];
                                                                                                                                                    } ?>" />
                                     </label>
                                 </div>
                             ...
                             <div class="col-md-8">
                                 <div class="form-group">
                                     <label>
                                         ...
                                         <input type="text" name="imgtext" class="form-control" required placeholder="Enter text visible on the image" value="<?php if (isset($_POST['imgtext'])) {
                                                                                                                                                                    echo $_POST['imgtext'];
                                                                                                                                                                } ?>" />
                                     </label>
                                 </div>
                             ...
                             <div class="col-md-8">
                                 <div class="form-group">
                                     ...
                                     <span class="help-block" id="er">Image Dimension Height: 310px, Width: 510px & (
                                         png, jpg ,jpeg )</span>
                                     <br><br />
                                     <script>
                                         function check() {
                                                 ...
                                                 if (typeof(fileUpload.files) !== "undefined") {
                                                     ...
                                                     reader.onload = function(e) {
                                                         ...
                                                         image.onload = function() {
                                                             ...
                                                             console.log(height);
                                                             console.log(width);
                                                             if ((height < 310) || (width < 510)) {
                                                                 document.getElementById('er').innerHTML =
                                                                     '<font color="red">Height must be 300px and Width must be 510px.</font>';
                                                                 document.getElementById('sub').disabled = true;
                                                             } else if ((height > 310) || (width > 510)) {
                                                                 document.getElementById('er').innerHTML =
                                                                     '<font color="red">Height must be 300px and Width must be 510px.</font>';
                                                                 document.getElementById('sub').disabled = true;
                                                             } else {
                                     ...
                                     <label>
                                         <input type="checkbox" name="click" class="form-control" <?php if (isset($_POST['click'])) {
                                                                                                        echo "checked ";
                                                                                                    } ?> style="height: 15px;margin: 0px; width: 3%;">
                 ...
                 <?php
                    if (isset($_POST['submit'])) {
                        ...
                        foreach ($slider_name as $key => $value) {
                            ...
                            $query = mysqli_query($conn, "INSERT INTO `offer_slider`(`image`,`cat_id`,`off_type`,`off_value`,`text_image`,`click`,`ad_date`,`ad_timer`) VALUES "
                                . "('$imgName','$subcategory','" . $_POST['oftype'] . "','" . $_POST['offvalue'] . "','" . $_POST['imgtext'] . "','$click','$date','$time')") or die(mysqli_error($conn));
                        }
                        ...
                        if ($query) {
                            ...
                            echo "<script type='text/javascript'>var x = document.getElementById('snackbar');x.style.visibility = 'visible';setTimeout(function(){ x.style.visibility = 'hidden'; }, 3000);";
                            ...
                            echo 'not added';
                            echo '<div id="snackbar">Could Not Add Slider..</div>';
                            echo "<script type='text/javascript'>var x = document.getElementById('snackbar');x.style.visibility = 'visible';setTimeout(function(){ x.style.visibility = 'hidden'; }, 3000);";
