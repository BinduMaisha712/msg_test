            ...
            <form action="" method="post">
                <div class="row">
                    <div class="col-lg-2">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item active"><span>Rewards Structure</span></li>
                        </ul>
                    ...
                    <form action="" method="post" id="form">
                        ...
                        <div class="col-lg-6 text-right">
                            <a class="btn btn-success" href="change-reward-structure.php">Change Reward Structure</a>
                        </div>
                    </form>
                </div>
            </form>
                    ...
                    <div class="miniStats--panel">
                        ...
                        <div class="miniStats--body">
                            ...
                            <a href="javascript:;" id="completeorder1">
                                ...
                                <h3 class="miniStats--title h4"><?php echo $data['min_amt'];?> (Expense)</h3>
                            </a>
