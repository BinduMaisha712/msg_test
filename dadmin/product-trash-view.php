                    ...
                    <div class="records--list">
                        <table id="recordsListView">
                            ...
                            if(isset($_SESSION['alert']))
                            {
                              ...
                              $query=mysqli_query($conn,"SELECT * FROM `products` WHERE trash = 'Yes' ORDER BY id DESC");
                              $sr=1;
                              ...
                              ?>
                                <tr>
                                    ...
                                    <td><?php echo $data['product_name'];?></td> 
                                      ...
                                      <td><a href="trash-product.php?eid=<?php echo $data['id'].'&Active=Active&trash=No'; ?>&product=<?=$data['group_code'];?>" onClick="return confirm('Are you sure you want to Restore this Product')" class="btn btn-success">Move to Live</a></td>
                                </tr>
