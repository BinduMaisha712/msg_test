    ...
    $(function () {
        ...
        if ( $recordsListView.length ) {
            $recordsListView.DataTable({
                ...
                //dom: '<"topbar"<"toolbar"><"right"li>><"table-responsive"b>p',
                dom: '<"topbar"<"toolbar">Bf<"right"li>><"table-responsive"t><"bottom"p>',
                order: [],
                columnDefs: [
                    {
                ...
                buttons: [
                    {
                        ...
                        exportOptions: {
                            modifier: {
                                page: 'current' // Sirf current page ka data export karega
                            }
                        },
                        customize: function(xlsx) {
                            var sheet = xlsx.xl.worksheets['sheet1.xml'];
                            $('row c[r^="C"]', sheet).attr('s', '2'); // Custom style apply karta hai
                        }
                    }
                ]
            });
