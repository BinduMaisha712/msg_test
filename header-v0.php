...
<body>
    ...
    <!--whats-app--> 
        ...
        <button class="scroll-top scroll-to-target" data-target="html"><a href="https://api.whatsapp.com/send?phone=8595135675" class="float scroll-top scroll-to-target open" target="_blank" data-target="html">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-2 col-lg-3 d-none d-lg-block">
                        <div class="logo">
                            ...
                            $logo = $homePage->logo();
                            ?>
                            <a href="index.php"><img src="asset/image/logo/<?= $logo['logo'] ?>" alt="Logo" width="100px"></a>
                        </div>
                    </div>
                    <div class="col-xl-10 col-lg-9">
                        <div class="d-block d-sm-flex align-items-center justify-content-start">
                            <div class="header-search-wrap">
                                ...
                                <form action="listing.php" class="search-bar productSearch2" method="get">
